...
void main() {
  group('gg_easy_widget_test_version.dart', () {
    test('matches the version in pubspec.yaml', () {
      ...
      final file = File('lib/src/gg_easy_widget_test_version.dart');
